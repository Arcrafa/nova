...
import os
sys.path.append('../..')
from PandAna.core import spectrum, save_spectra, load_spectra
...
def main(dest, source):
    ...
    save_spectra(dest, list(dest_spectra.values()), list(dest_spectra.keys()))
